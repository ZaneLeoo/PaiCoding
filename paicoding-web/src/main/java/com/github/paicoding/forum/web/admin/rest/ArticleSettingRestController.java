...
//
//
//    public void setArticleSettingService(ArticleSettingService articleSettingService) {
//        this.articleSettingService = articleSettingService;
//    }
//
//    @Autowired
//    @Lazy
...
//    public ResVo<ArticleContentDO> detail(@RequestParam(name = "articleId", required = false) Long articleId) {
//        ArticleContentDO content = new ArticleContentDO();
//        if (articleId != null) {
//            // 查询文章详情
//            content = articleReadService.queryContentArticleInfo(articleId);
//        }
//
